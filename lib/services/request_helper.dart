...
import 'package:paygo/services/utils/constants.dart';
import 'package:paygo/services/utils/errors.dart';
...
final class RequestHelper {
  ...
  Future<String> _refreshAccessToken(
    ...
    try {
      final refreshResponse = await dio.post(
        '$baseUrl/zyber/paygo/api/auth/refresh',
  ...
  Future<dynamic> post(
    ...
    try {
      ...
      if (e.response?.statusCode == 401 || e.response?.statusCode == 403) {
        ...
        if (path == "/zyber/paygo/api/auth/register") {
          router.go(Routes.splashScreen);
  ...
  Future<dynamic> putWithAuthMultipart(
    ...
    // If additionalParams are provided, append them to the URL as query parameters
