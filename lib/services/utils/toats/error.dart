...
void showErrorToast(BuildContext context, String title, String message) {
  toastification.show(
    ...
    title: Text(title.tr(),style: AppStyle.fontStyle.copyWith(fontWeight: FontWeight.bold,color: AppColors.backgroundColor),),
    description: Text(message.tr(),style: AppStyle.fontStyle.copyWith(fontWeight: FontWeight.bold,color: AppColors.backgroundColor),),
